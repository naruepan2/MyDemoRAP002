"! @testing BDEF:zcl_rap_nw_tc_travel_eml_001
CLASS zcl_rap_nw_tc_travel_eml_001 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS zcl_rap_nw_tc_travel_eml_001 IMPLEMENTATION.
  METHOD class_setup.
    " create the test doubles for the underlying CDS entities
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZI_RAP_NW_TRAVELTP_001' ) ) ).
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF zi_rap_nw_traveltp_001
...
*    COMMIT ENTITIES RESPONSE OF zi_rap_nw_traveltp_001
...
" no failures expected
   ...
   SELECT * FROM zi_rap_nw_traveltp_001 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
