CLASS zcl_rap100_gen_data_nwr DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_nwr IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap_nw_atrav001.
*    DELETE FROM zrap100_dtrav###.

    "insert travel demo data
    INSERT zrap_nw_atrav001  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table zrap_nw_atrav001. | ).
  ENDMETHOD.
ENDCLASS.
